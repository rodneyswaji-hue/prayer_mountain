...
<section id="culture" className="py-24 bg-white relative overflow-hidden">
  <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
    ...
    <div className="relative w-full h-[450px] rounded-2xl overflow-hidden shadow-xl bg-gray-100">
      ...
      {/* COMMUNITY TRIBUTE / IMPACT SECTION */}
      <section  id="partners" className="py-24 relative overflow-hidden text-white border-y border-green-900">
        
        {/* Background - Changed to abstract/warm imagery */}
        <div className="absolute inset-0 z-0">
          {/* Using a generic 'light/hope' placeholder. Replace with an image of your site foundation or a prayer circle */}
          <img 
            src="https://images.unsplash.com/photo-1499209974431-9dddcece7f88?q=80&w=2000&auto=format&fit=crop" 
            alt="Faithful Community Support" 
            className="w-full h-full object-cover filter grayscale contrast-125 brightness-50"
          />
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            {/* LEFT: Tribute & Context */}
            <div>
              <span className="inline-block py-1 px-3 rounded-full bg-yellow-500/20 border border-yellow-400/30 text-yellow-300 text-xs font-bold tracking-widest uppercase mb-6">
                Kingdom Builders
              </span>

              <h3 className="text-3xl md:text-4xl font-bold mb-6 leading-tight">
                Built Upon The Generosity of <br />
                <span className="text-green-400">Faithful Families</span>
              </h3>

              <p className="text-gray-200 mb-6 leading-relaxed text-lg">
                We extend our deepest gratitude to the families and individuals who have stepped forward to sow the first seeds for the Prayer Center. 
                Unlike public institutions, this vision is being fueled by <strong>silent stewards</strong> who believe in the power of prayer.
              </p>

              <p className="text-gray-200 mb-8 leading-relaxed text-lg">
                Your contributions—given not for recognition, but out of faith—have allowed us to move past the planning phase and secure the resources needed to begin. You are the hands that are building this foundation.
              </p>

              <blockquote className="border-l-4 border-yellow-500 pl-4 italic text-gray-300 font-serif text-lg">
                "But when you give to the needy, do not let your left hand know what your right hand is doing, so that your giving may be in secret."
                <footer className="text-sm font-bold text-yellow-400 mt-3 not-italic">
                  — Matthew 6:3–4
                </footer>
              </blockquote>
            </div>

            {/* RIGHT: Impact Status Card */}
            <div className="bg-white/5 backdrop-blur-md border border-white/10 p-8 rounded-2xl relative shadow-2xl">
              ...
              <div className="space-y-8 relative border-l border-white/20 ml-3 pl-8">

                {/* Step 1: Received */}
                <div className="relative">
                  <span className="absolute -left-[39px] top-1 flex items-center justify-center w-6 h-6 rounded-full bg-green-500 text-black text-xs font-bold">✓</span>
                  <h5 className="text-white font-bold text-lg">Seed Funds Received</h5>
                  <p className="text-sm text-gray-300 mt-1">
                    Contributions from private donors have successfully been received, securing the initial budget.
                  </p>
                </div>
                ...
                <div className="relative">
                  <span className="absolute -left-[39px] top-1 flex items-center justify-center w-6 h-6 rounded-full bg-yellow-500 text-black text-xs font-bold animate-pulse">●</span>
                  <h5 className="text-yellow-400 font-bold text-lg">Resource Allocation</h5>
                  <p className="text-sm text-gray-300 mt-1">
                    Funds are currently being deployed for site preparation and material acquisition.
                  </p>
                </div>
                ...
                <div className="relative opacity-80">
                  <span className="absolute -left-[39px] top-1 flex items-center justify-center w-6 h-6 rounded-full bg-white/20 text-white text-[10px]">➜</span>
                  <h5 className="text-white font-bold text-lg">The Vision Unfolds</h5>
                  <p className="text-sm text-gray-300 mt-1">
                    Thanks to these gifts, physical development is now visible on the horizon.
                  </p>
                </div>
